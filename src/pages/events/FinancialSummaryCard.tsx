  ...
  return (
    <div className="bg-beetz-dark text-white rounded-2xl p-6 shadow-soft border border-beetz-dark/5">
      ...
      <p className="text-sm text-white/50 mb-5">
        Vendas, percentual e créditos são entradas manuais. Repasses agora tem aba própria (lançamentos
        e histórico ficam lá). Os demais valores são calculados a partir das despesas, produtos e consumo
        da produção lançados neste evento.
      </p>
      ...
      {loading || !summary ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 pt-5 border-t border-white/10">
          ...
          <SummaryTile label="Repasses à produtora" value={summary.repasses} />
